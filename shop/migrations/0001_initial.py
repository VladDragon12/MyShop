    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, default='Без названия', help_text='Введите название категории', max_length=200, verbose_name='Название')),
                ('slug', models.SlugField(help_text='Уникальный URL-адрес категории', max_length=200, unique=True, verbose_name='URL-адрес')),
